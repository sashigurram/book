...
The core \gls{matsim} architecture---where agents learn utilities for plans---was originally derived from the field of \gls{cas}
% acronym ok. kai, aug'15
\citep[e.g.][also see Section~\ref{sec:streams}]{AxelrodBook,Holland_1992,HraberJonesForrestEcho,PalmerEtAl_PhysicaD_1994}. 
...
\gls{cas} focuses on many agents, agent interaction and emergence. \Gls{ai} kai, aug'15
...
%
For many aspects of \gls{its} systems, within-day replanning is indispensable \citep[e.g.,][]{hall-1993,EmmerinkEtAl_TransResC_1995,Dobler_PhDThesis_2013}.
%
