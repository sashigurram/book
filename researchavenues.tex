...
%The challenge that transport research has amply documented is that the 
Travelers value different elements of their experience at different average rates; for example, one usually has different values of travel time savings by mode and by trip purpose. 
% on average and certainly with large variances between each other. 
In addition, there are large variances between travelers.  Some of these differences might be due to the omission of the daily schedule context; for example, higher values of time for commuting than for leisure may be caused by the more crowded daily schedule on working days.
