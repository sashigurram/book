...
\gunnar{Es gibt hier zwei kontr\"are Sichtweisen. \"Okonometriker wie Fosgerau, Karlstr\"om, Bierlaire argumentieren
...
richtig zu finden, wie es kein vernünftiges und kalibrierbares Modell gibt, das die Formierung eines choice
...
der choice set generation, das wird dann Prato, nicht aber besagte \"Okonometriker erfreuen.}
...
\]
since that confuses the scale parameters of the two separate estimations.\gunnar{b' war im eco-Kapitel die Zeitableitung von b.}\footnote{%
%
