...
%\ahtodo{Aguirre et al reference looks weird (quotes before second epsilon)}

%\ahtodo{Andre et al: european $\to$ European}

%\ahtodo{Balac et a;: zurich $\to$ Zurich}

%\kaitodo{Büttner et al: ``für'' nicht richtig} \ah{tub.bib: BuettnerEtAl2010Erreichbarkeitsatlas}

%\ahtodo{Paper presented at Proceedings ... kommt öfter vor.  Liegt am iatbr style.  Soll ich das ``paper presented at'' rausstreichen, oder passt Du die Einträge überall an? \kai{Ist das jetzt vielleicht geloest?}} \ah{sehe ich auch so.}

%\kaitodo{Curtis et al: Zuviel Großschreibung im title} \ah{tub.bib: CurtisEtAl2013AccessibilityPolicyInnovation}

%\ahtodo{Dobler (2010): matsim kleingeschrieben}

%\ahtodo{Swiss Federal ... (2001): Der Strich vor ``Sektoren'' sollte typographisch -- und nicht - sein.}
