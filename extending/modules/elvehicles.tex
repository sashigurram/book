...
\createStandardInformationBasic{\url{http://matsim.org/javadoc} $\to$ transEnergySim}{No predefined invocation. A starting point is \lstinline|RunTransEnergySimExample| class.}{No typical \gls{matsim} config.}{\citet[][]{WaraichEtAl_TRR_2013, GalusEtAl_STRC_2009, WaraichEtAl_IATBR_2009, GalusEtAl_ITSG_2012, Waraich_PhDThesis_2014, WaraichEtAl_TechRep_IVT_2013, GalusEtAl_ResRep_EWZ_2012, Waraich_unpub_EURO_2012, Waraich_unpub_MATSimUserMeeting_2012, WaraichEtAl_JanssensEtAl_2014, WaraichAxhausen_SDEWES_2013}}
