...
\ah{Btw: when exactly (revision?) did we switch to events-based scoring? Is relevant in other chapters too.}\kai{MZ should know this.}\thibaut{plan elements from the plans stopped being passed to the scoring function from r17026 on (24 Oct 2011).}
