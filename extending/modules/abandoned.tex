...
\ah{Still it used its own scoring function, that was then applied in various succeeding projects (e.g., VW), right? Btw: when exactly (revision?) did we switch to events-based scoring? Is relevant in other chapters too.}
