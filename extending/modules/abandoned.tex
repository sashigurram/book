...
\item Planomat did not re-use core MATSim structural information, but built its own model of the environment.  For example, it would not use the MATSim core scoring function provided by the infrastructure, but compute its own score based on the events. \kai{Thibaut or Andreas H., is this correct?}  
