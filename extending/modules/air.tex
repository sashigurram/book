...
%\mnote{OAG}
The air traffic technology model uses data provided by OAG \ah{glossary} Aviation\footnote{\url{www.oagaviation.com}, last access 08.08.2012}. 
...
The travel time, $tt$, is computed by the microsimulation, with an estimation of the beeline distance between the \gls{od} pair $d$ and a velocity $v$, \ie $tt = d / v$.  
