...
% ##################################################################################################################
Cadyts (Calibration of Dynamic Traffic Simulations) is a calibration tool that adjusts MATSim plans such that a measured calibration target is meet. Often count data is used as empirical data source.

The plan-specific utility corrections are composed of link- and time-additive correction terms $\Delta V_a(k)$.
In case congestion can be assumed to be light and traffic counts are independently and normally distributed, these link- and time-additive correction terms become \cite[p.487]{FloetteroedChenEtAl2011BehavioralCalibAndAnaNETS}
\begin{equation}
