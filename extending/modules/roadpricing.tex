...
{\citet{RieserEtAl2008ITMEveningToll}}
% ------------
%% \kai{Das Bild ist m.E.\ nur in dem ITM paper, welches aber nie über die Konferenz hinaus publiziert wurde.  Sollte also unproblematisch sein.}
...
{}
%% \kai{Bin mir relativ sicher, dass das nirgendwo publiziert ist.}
% ------------
