...
% ##################################################################################################################
This chapter presents an integrated approach for performing evacuation simulations with \gls{matsim} using the evacuation \gls{contribution}. %GRIPS stands for GIS-based Risk-Analysis-, Information-, and Planning-System for Regional Evacuation. 
...
An independent evacuation scenario, not using the evacuation, is presented in Chapter~\ref{ch:aliaga}.
...
\label{grips:scm}
The scenario setup, evacuation simulation, and analysis are handled by the \lstinline|ScenarioManager| from the \gls{matsim} \gls{contribution} package \lstinline|org.matsim.contrib.evacuation|, 
% =====================================================================================================
...
\section{Conclusion}
\label{grips:outlook}
This chapter demonstrates how rapid evacuation planning can be performed with help of the evacuation \gls{contribution}. The evacuation \gls{contribution} provides an interactive \gls{gui} to perform this task.
