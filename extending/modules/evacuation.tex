...
%\subsection{Evacuation area selection}
%\begin{figure}[htbp]
%\includegraphics[width=.49\textwidth]{img/evac_area_sel}
%\end{figure}
%\subsection{Defining the evacuation population}
%\begin{figure}[htbp]
%\includegraphics[width=.49\textwidth]{img/pop_sel}
%\end{figure}
%\section{Case study}
%\hl{TODO: case study HH-Willhelmsburg}
%\section{Future work}
%\hl{TODO: discuss what we want to do in future}
