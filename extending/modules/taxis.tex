...
\createStandardInformation{dvrp}{No predefined invocation. Setting up a \lstinline|VrpOptimizer| and coupling it with MATSim requires some tailor-made code as shown in Section~\ref{sec:dvrp_config}}{No typical MATSim config}
{
