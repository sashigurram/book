...
\createStandardInformation{dvrp}{No predefined invocation. Setting up \lstinline|VrpOptimizer| and coupling it with MATSim requires lots of coding and each time may look completely different as shown in Section~\ref{sec:dvrp_config}}{No typical MATSim config}
{
