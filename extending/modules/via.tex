...
by \gls{senozon}, an ETH Spin-off company founded by two former PhD students
...
for visualization purposes, e.g., having different colors for vehicles
...
By using custom data tables, e.g., containing more information about trips, i.e.
