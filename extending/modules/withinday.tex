...
{(Iterative) within-day replanning MATSim loop \kai{I think this figure needs to come earlier, i.e.,\,in Section~\ref{sec:SimulationApproaches}}}%
...
Wir mussten das parking + withinday aus zeit/Performance gründen abbrechen (wir sind momentan an einer psim + withinday + parking variante daran). Es gibt folgende zwei Paper dazu: \citet[][]{WaraichEtAl_unpub_TRB_2013, Waraich_unpub_IATBR_2012}.
}
