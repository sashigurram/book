...
\createStandardInformationBasic{\url{http://matsim.org/javadoc} $\to$ pseudosimulation}{\url{http://matsim.org/javadoc} $\to$ pseudosimulation $\to$ \lstinline|PSimControler| class}{No typical \gls{matsim} config.}{\citet[][]{FourieEtAl_TRR_2013}}
% ##################################################################################################################
