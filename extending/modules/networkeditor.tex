...
%% \kai{todo the below for the two editors.  See withinday planning for an example how to deal with two such section}
...
%% \kai{contrib not there}

%% \kai{runnable scripts not according to the ``RunXxx'' convention (they do not even ``run'' since they do not have a main method)}
