% ##################################################################################################################
\chapter{MATSim JOSM Network Editor}
\label{ch:josm-network-editor}

\hfill \textbf{Authors:} Andreas Neumann, Michael Zilske
...
\label{sec:basic-information-josm-plugin}

\createStandardInformationBasic{%
%
\entryStd{josm-plugin}%
%
}{%
%
...
%
Can be configured from inside the JOSM editor.
%
}{%
%
\cite{Kuehnel2014BaJosmPlugin} (in German)
%
}
% Cannot use std inf w/o basic because it is not in contrib. kai, dec'15
...
% ##################################################################################################################
\chapter{Map-to-Map Matching Editors in Singapore}
...
\createStandardInformationBasic{%
%
\entryStd{networkEditorSingapore}%
%
}{
%
%% \invokeStd{networkEditorSingapore}{\lstinline|DoubleNetworkMatchingWindow| class,  \lstinline|DoubleNetworkCapacitiesWindow| class}
See \entryStd{networkEditorSingapore} for more information
%
}{
%
in the GUI
