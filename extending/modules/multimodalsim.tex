\chapter{The ``multi-modal'' Extension}
...
\gls{matsim}'s standard \gls{mobsim}, \gls{qsim}, has recently been enabled to model \gls{multimodal} scenarios as shown in Section~\ref{sec:multimodalsim_qsim}.\kai{chk}
