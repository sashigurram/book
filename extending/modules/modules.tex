...
for example, python is allowed in \gls{qgis}\footnote{\url{http://docs.qgis.org/testing/en/docs/pyqgis_developer_cookbook/}}, 
\gls{visum}\footnote{\citet{VISUM_manualNewFeatures_2011}},
\gls{emme}\footnote{\url{http://www.inrosoftware.com/en/products/emme/}}, or 
\gls{sumo} (via the traci interface)\footnote{\url{http://sumo.dlr.de/wiki/TraCI}} 
for plug-ins.
