...
By specifying the parameter \lstinline|ModuleSubpopulation_X|, i.e.,\,<param name="ModuleSubpopulation_1" value="externalAgent"/>| replanning strategies can be applied to distinct sub-populations.
