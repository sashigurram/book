...
% ===================================================================================
\subsection{Signals \who{Theresa?}}
...
% ##################################################################################################################
\section{Special Purpose Modules and Tools}
Parking is presented in Chapter \ref{ch:parking}. The network editors developed in Berlin and Singapore are detailed in Chapter \ref{ch:networkeditor}. The adoption of business analytics tools in MATSim is described in Chapter \ref{ch:businessanalytics}. Emisssions chapter \ref{ch:emissions}.
...
% ===================================================================================
\subsection{Accessibility \who{Ziemke}}
-> Vortrag Wiepersdorf
Modules in the config: 
\begin{itemize}
