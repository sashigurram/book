...
\item Click on the \gls{matsim} jar file\footnote{This works since winter 2014/15 and should be in the 0.8.x~release.} and follow the instructions. 
\end{itemize}
...
%
There used to be an additional ``useHouseholds'' config switch.  In relase 0.8.x, that switch will be gone.
%
}
