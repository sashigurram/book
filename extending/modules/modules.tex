...
% ##################################################################################################################
\subsection{Demand-Side Modules and Specific Transport Modes Modules}
\label{sec:dsm}
...
\kai{is vehicles demand side or supply side?  Wenn die Fahrzeuge vom Staat bereitgestellt würden, wäre es wohl offensichtlich supply side, oder?  Wenn in der Datei Busse drin sind (was sie ja sind), ist das m.E.\ auch supply side.  --  Ich muss sagen, ich mag diese Unterteilung ohnehin nicht besonders gerne.  Ich kann damit leben, solange man die ``mobsim'' raushält; die ist weder demand noch supply, sondern ``Schiedsrichter''.}
...
\kai{muss/sollte dies vielleicht direkt hinter ``matsim data containers'' (also noch vor ``strategy modules'')?}
...
\textcolor{gray}{Another possibility to customize the controler is by inheritence from the class \lstinline|org.matsim.core.controler|.}  \kai{Please do not do or advertise this any more.}
