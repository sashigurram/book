...
\endlastfoot
	...
	Network Editors & Contrib \kai{/external?} &  Chapter~\ref{ch:networkeditor} \\
...
\citet[][]{JaeggiEtAl_TRR_2012} might serve as an empirical base for the assignment of vehicles to agents or households.
%% \end{itemize}
