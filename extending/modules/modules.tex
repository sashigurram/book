...
%% gibt es nicht mehr. kai, jul'15
	...
	%\hline
	%\textbf{Mobsims} & Section~\ref{sec:using-mobsims} and Chapter~\ref{sec:extending-qsim} \\
	%\hline
	...
	%\hline
	%Network Editors & Chapter~\ref{ch:josm-network-editor} through \ref{ch:contrib-networkEditor}\\
	...
	%\gls{matsim}4UrbanSim & Chapter~\ref{sec:matsim4urbansim} \\	
%\end{longtable}
%\end{center}
