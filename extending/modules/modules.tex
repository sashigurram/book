...
Factory functionality is provided by these classes.
\lstinline|PopulationUtils| for example contains a \lstinline|createPopulation(...)| method.
...
for example, python is allowed in \gls{qgis}, 
\gls{visum},
\gls{emme}, or 
