...
% -----------------------------------------------------
\subsubsection{Multi-Modal Simualtion}
...
2) Config - Set link dynamics from available options (Passing or FIFO) and inform qsim and router about main congested modes.
