...
Passing is all-or-none; more fine-grained rules about passing (which mode can overtake which other mode) do not yet exist at the time of writing this book. 
