...
\endlastfoot
	...
	Network  & Section~\ref{sec:network} and \ref{sec:lgstartednetwork} \\
	Population &  Section~\ref{sec:population} and \ref{sec:lgstarted-population} \\
	...
	\hline
	Controler &  Section~\ref{sec:controler} and \ref{sec:using-controler} \\
	Global &  Section~\ref{sec:global} \\
	Parallel Computing &  Section~\ref{sec:parallelcomputing} \\
	\hline
	\textbf{Mobsims} & Section~\ref{sec:mobsims} and \ref{sec:using-mobsims} \\
	\hline
	QSim &  Section~\ref{sec:qsim} and \ref{sec:using-qsim} \\
