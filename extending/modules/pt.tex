...
\citep{Dijkstra1959ShortestPath}, but modified to take
...
\begin{itemize}\styleItemize
	...
	%
	\item WagonSim: In the WagonSim contribution (see Chapter~\ref{sec:wagonsim})
...
Most case studies covered by the \citet[][]{Neumann_PhDThesis_2014} thesis indicate that paratransit services are mainly 
