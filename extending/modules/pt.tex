...
\createStandardInformationBasic{{\url{http://matsim.org/javadoc} $\to$ core $\to$ signals}}{The module is invoked by enabling it in the configuration. It is part of the \gls{matsim} core.}{\lstinline{transit} section(s) of the config file.
