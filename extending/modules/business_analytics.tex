...
% ------------
\createfigure%
{General framework of the decision support system (Source: \citep{ErathEtAl_EASTS_2013})}%
{General framework of the decision support system (Source: \citep{ErathEtAl_EASTS_2013})}%
...
% ------------
\createfigure%
{Simplified entity relationship diagram showing shared keys across tables (Source: \citep{ErathEtAl_EASTS_2013})}%
{Simplified entity relationship diagram showing shared keys across tables (Source: \citep{ErathEtAl_EASTS_2013})}%
