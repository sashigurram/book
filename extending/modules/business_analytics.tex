...
\createStandardInformationBasic{\citet{Tableau_Webpage_2013}}{Standalone GUI of Tableau Software \citep{Tableau_Webpage_2013} and \lstinline|contrib.analysis.travelsummary| for pre-processing}{in the GUI}{\citet[][]{ErathEtAl_EASTS_2013}}
