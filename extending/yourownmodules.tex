...
A \verb$PlanStrategy$ is a piece of code which specifies how an agent changes its behavior
from iteration to iteration. Most generally, it is an operation on the plan memory
