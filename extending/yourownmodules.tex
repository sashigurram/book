...
Please check the documentation of the \lstinline{TripRouter} class  (see \url{http://matsim.org/javadoc}) for more details and pointers to examples.
...
Please check the documentation of the \lstinline{getTripRouterFactory()} method of the \lstinline{Controler} class (see \url{http://matsim.org/javadoc}) for pointers to examples.
