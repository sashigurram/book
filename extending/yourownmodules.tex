...
Furthermore, there is a utility class \lstinline|ReflectiveConfigGroup| which you can use if you want to define the mapping of named parameters to accessors using \gls{java} annotations.  \kaitodo{See ... for an example.}
