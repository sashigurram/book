...
\item \lstinline{org.matsim.contribs.networkEditor.*}\footnote{This contribution is not presented in the book. Instead, to external editors also developed by MATSim team members are presented in Chapter~\ref{ch:networkeditor}} %presented in Chapter~\ref{ch:networkeditor} \ah{afaik: the 2 presented ones are external}
