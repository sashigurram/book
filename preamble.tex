...
\usepackage{listings}
\lstset{language=Java,belowskip=-4pt,basicstyle=\ttfamily\footnotesize,lineskip=-1pt,keywordstyle=\bfseries\color{blue},keywordstyle={[2]\bfseries\color{magenta}},commentstyle=\bfseries\color{red},stringstyle=\bfseries\color{ForestGreen},showstringspaces=false,frame=none,string=[b]",morekeywords={},morekeywords={[2]%
%
Comparator,String,
%
