...
backgroundcolor=\color{shadecolor},
%
\lstset{belowskip=-4pt,language=XML,basicstyle=\ttfamily\footnotesize,lineskip=-1pt,commentstyle=\bfseries\color{red},stringstyle=\bfseries\color{ForestGreen},showstringspaces=false,frame=none, string=[b]",morekeywords={[2]
%
description,
%
