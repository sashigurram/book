...
\pagestyle{fancy}%
\fancyhf{}%
\fancyhead[LE,RO]{\slshape \footnotesize \nouppercase{\rightmark}}
\fancyhead[LO,RE]{\slshape \footnotesize \nouppercase{\leftmark}}
...
\lstnewenvironment{xml}{\lstset{belowskip=-4pt,language=XML,basicstyle=\ttfamily\footnotesize,lineskip=-1pt,commentstyle=\bfseries\color{red},stringstyle=\bfseries\color{ForestGreen},showstringspaces=false,frame=none,string=[b]",morekeywords={[2]
%
description,
%
...
\newcommand{\kwaah}[1]{{\color{blue} [\textbf{kwaah}: #1]}}
