...
backgroundcolor=\color{shadecolor},
%
belowskip=-4pt,language=XML,basicstyle=\ttfamily\footnotesize,lineskip=-1pt,commentstyle=\bfseries\lst@ifdisplaystyle\color{red}\fi,stringstyle=\bfseries\lst@ifdisplaystyle\color{ForestGreen}\fi,showstringspaces=false,frame=none, string=[b]",morekeywords={[2]
%
description,
%
