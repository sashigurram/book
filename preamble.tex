...
\lstnewenvironment{xml}{\lstset{belowskip=-4pt,language=XML,basicstyle=\ttfamily\footnotesize,lineskip=-1pt,commentstyle=\bfseries\color{red},stringstyle=\bfseries\color{ForestGreen},showstringspaces=false,frame=none, backgroundcolor=\color{shadecolor}, string=[b]",morekeywords={[2]
%
description,
%
...
\newcommand{\mnote}[1]{\medskip\centerline{\textbf{\footnotesize\color{blue}\hfill #1}}\vspace{-.8em}}
