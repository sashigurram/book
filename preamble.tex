...
%
language=Java,belowskip=-4pt,basicstyle=\ttfamily\lst@ifdisplaystyle\footnotesize\fi,lineskip=-1pt,keywordstyle=\lst@ifdisplaystyle\bfseries\color{blue}\fi,keywordstyle={[2]\lst@ifdisplaystyle\bfseries\color{magenta}\fi},commentstyle=\bfseries\color{red},stringstyle=\bfseries\color{ForestGreen},showstringspaces=false,frame=none, string=[b]",morekeywords={},morekeywords={[2]%
%
Comparator,String,
%
