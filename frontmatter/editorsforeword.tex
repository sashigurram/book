...
\ah{A special thank goes to a number of people, who greatly helped improving this book beyond their own chapters.
Benjamin Kickhöfer's, and Gunnar Flötteröd's deep knowledge on \gls{matsim}'s mathematical base, in particular its interpretation within the discrete choice framework, made the discussions accompanying the writing of this book very fruitful. 
Thibaut Dubernet's, Marcel Rieser's and Michael Zilske's outstanding expertise on software core development helped us a lot to also improve the software structure while writing this book.
Marcel Rieser's layout and illustration improved this book's look greatly.
Joschka Bischoff's effort to document the basic information about every module, will greatly help readers to step into respective functionality quickly.
}

The very precise and productive copy editing by Karen Ettlin is greatly acknowledged. It is funded by the \gls{snf}-grant number \ah{...} and the \gls{tu} Berlin grant \ah{...}
...
% ##################################################################################################################
% \ah{We merge somehow, Foreword and Preface, but it is much nicer like that, than split}
