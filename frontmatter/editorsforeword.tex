...
\ah{Benjamin Kickhöfer's, and Gunnar Flötteröd's deep knowledge on \gls{matsim}'s mathematical base, in particular its interpretation within the discrete choice framework, made the discussions necessary to write this book very fruitful. Thibaut Dubernet's outstanding expertise on software core development helped us a lot to also improve the software structure while writing this book.}

A special thank goes to the Karen Ettlin, for the very precise and productive copy editing. The copy editing is funded by the \gls{snf}-grant number ... and the \ah{TUB fund}
