...
%%\kai{Ist Michael Balmer wirklich Mitglied des ``committees''??}

%%\kai{Erwähnen wir die Editoren des Buches nicht?  Wenigstens eine Bemerkung ``besides the editors of this book''.}
...
%Volkswagen AG \kai{???  Vielleicht eher ``foundation'??}  
...
%%\kai{Und wenn wir die VWF angeben, dann muss noch evtl.\ noch weitere angeben.}
