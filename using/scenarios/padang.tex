...
\caption{Evacuation time analysis for downtown Padang. Numbers showing average evacuation time in mintues, which is also indicated by the colors green, yellow, red.}\label{chap:evac:fig:sc_man}
\end{figure}
