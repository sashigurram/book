...
%
\citet{KickhoeferKern_TRD_2015} went one step further and calculated time-dependent, vehicle-specific air pollution exposure tolls to correct toll levels with \citet{KickhoeferNagel2013EmissionInternalizationNETS} for a count of individuals affected.
