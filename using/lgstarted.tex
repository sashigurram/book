...
%\ah{nicht sicher, ob es das braucht, aber vielleicht hilft es die Ungeduld des eher fortgeschrittenen Anwenders zu kanalisieren, wenn er z.B. Pt simulieren will.} \kai{Meiner Intuition nach sind ``forward pointer'' fast immer gut.}
...
% --------------------------------------
Figure 2: A scientific method to creating a model from a real world \[10\]:
...
\ah{Obige Punkte weiter einbauen und auf MATSim practice zuschneiden.}
