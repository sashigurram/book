...
A relatively new feature is that one can use \gls{matsim} as a \gls{maven} plugin; both release versions and snapshots are available.  See again \url{http://matsim.org/downloads} for more information.  For someone who has used \gls{maven} before, this is possibly the best option.
%
