...
In line with the requirements of \eg simulated annealing approaches, the removal of candidates can be configured to be probabilistically dependent on the plan score similar to the selection in \lstinline|SelectExpBeta|. This reduces the probability to get stuck with sub-optimal plans, that were dominant in earlier iterations.
