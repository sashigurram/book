...
It is currently not possible to generate different vehicle types from the config alone; one either needs to provide a vehicles file (see Section~\ref{sec:extending-vehicles} and Chapter~\ref{sec:vehicles-in-qsim}), or write a script-in-\gls{java} to generate the vehicle fleet (again see Chapter~\ref{sec:vehicles-in-qsim}).  
