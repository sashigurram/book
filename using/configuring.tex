...
\kai{This ends up being quite long.  What to do?  Maybe (again) cut into two pieces: (1) by config; (2) extensions--???}
...
\paragraph{Teleportation with teleported mode speed}
