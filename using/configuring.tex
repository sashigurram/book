...
\ah{was not easy to read. reformulated it. pls check }
...
It is possible to give each planned route a list of possible vehicle \glspl{id} to be used for this route.  \ah{I think this is not easy to understand, but yes, the ref will probably clarify this}
This is discussed \kai{where?}.
