...
\ah{Mal was probiert, wie befürchtet mit kleinem Informationsgehalt.}
...
\ah{sollte man immer noch von proba reden, wo wir sie doch im Code endlich losgeworden sind? Andererseits ist es ja am Ende des Tages tatsächlich eine proba.}

By specifying the parameter \lstinline|subpopulation|, e.g.,
\begin{xml}
	<parameterset type="strategysettings" >
		<param name="strategyName" value="ChangeLegMode" />
		<param name="weight" value="0.1" />
...
\end{xml}
\kai{obiges hat jetzt 2x ``changeLegMode''.  Kann zwar sein, dass das tatsächlich so ist, aber falls ja, sollten wir explizit sagen, dass das kein Tippfehler ist.}
%
