...
\hfill \textbf{Authors:} Kai Nagel, Benjamin Kikchöfer, Andreas Horni, David Charypar
...
\kai{chk if default betaTrav was changed to zero when going to print}
...
%% In consequence, the Vickrey parameters of $\alpha$, $\beta$ and $\gamma$ \citep{ArnottEtcBottleneck-inelastic} are consistent with the following equations:
%% \begin{equation}
%% \begin{array}{ccrc}
