...
For the basic function, the utility of a plan $U_{plan}$ is computed as the sum of all activity utilities $U_{act,i}$ plus the sum of all travel (dis)utilities $U_{trav,i}$:
%
\begin{equation}
\label{eq:matsimUTF}
U_{plan}=\sum^n_{i=1} U_{act,i} + \sum^n_{i=2} U_{trav,i}
\end{equation}
...
U_{trav, i} = \beta_{trav, i} \cdot t_{trav, i} \,
\end{equation} 
where:
\begin{itemize} 
\item $\beta_{trav, i}$ is the marginal utility of travel by mode (normally negative or zero), and
...
\begin{itemize}
\item $\beta_{dur,i}= 6\ EUR/h$,
\item $\beta_{trav, mode, i}= -6\ EUR/h$,
\item $U_{wait,i}=0\ EUR/h$,
\item $\beta_{late.ar,i}=-18\ EUR/h$,
\item $\beta_{early.dp,i}=-18\ EUR/h$.
\end{itemize}

\ah{$\beta_{short.dur,i}$ is not defined on page 393.}
...
% ======================================================================================================================
\paragraph{Calibration Project Westumfahrung Zürich:}
...
% ======================================================================================================================
\paragraph{Estimation Kickhöfer:}
...
\item $t_{trav, i}$ gives the travel time between location of activity $q-1$ and $q$
...
\ah{Gesamtanalyse und Vergleiche aller Beiträge hier angeben.}
