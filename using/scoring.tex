...
\label{sec:paramset}
The basic Charypar-Nagel scoring function is inspired by \citet[][]{ArnottEtAl_TAER_1993}, which provides an extension of the Vickrey model \citep[][]{Vickrey_TAER_1969}. Parameters are thus derived from this model by also consulting \citet[][]{ChaumetEtAl_2006}. 
%
A frequently applied parameter set is the following 
%
\ah{Wollen wir uns so weit vorwagen oder doch einfach einige verlinken? Was benutzt ihr überhaupt am VSP? Kann man untenstehendes als Startpunkt geben. Charypar-Nagel-Paper.}
%
\begin{compactitem}
...
\ah{Hier Schätzung von Kickhöfer/Project WU etc. erwähnen und etwas History wie man auf die Werte kommt?}
...
\ah{Sollte ins Parking Chapter rein}
...
\ah{dc chapter oder research avenues.UTF}
