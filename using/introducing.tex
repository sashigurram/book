...
In the earlier \gls{deqsim} and in the current \gls{jdeqsim} a \emph{minimum} inflow capacity can be specified in addition to capture breakdowns at link entries \citep[][p.~99]{Charypar_PhDThesis_2008}.
