...
%
\item \textbf{Computational phyiscs:}
...
%
\item \textbf{Microscopic behavioral modeling of demand:}
%\textbf{Agent-Based Modeling:} 
\gls{matsim} uses a microscopic description of demand by \emph{tracing the daily schedule} and the decisions involved of the agents modeled.  This may be called ``agent-based'' in retrospect.
%
\item  \textbf{Co-evolutionary algorithms:}
...
\kai{Habe das jetzt auch nochmal angefasst.  Irgendwie komme ich doch aus einer anderen Ecke ...}
...
{\protect\gls{matsim} loop, sometimes called the \protect\gls{matsim} cycle \kai{replace ``execution'' by ``mobsim''?}}%
