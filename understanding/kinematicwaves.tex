...
(default: 15\,kilometers per hour ... seems to be taken in m/s in the code, I'll ask Rash). 
...
\ah{in \gls{jdeqsim} there is the \lstinline|minimumInFlowCapacity| parameter for this?. Discuss with Rash.}
%
