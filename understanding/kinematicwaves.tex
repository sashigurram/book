...
MATSim comes with a number of \glspl{mobsim}. These differ from the
...
All \glspl{mobsim} in MATSim implement the same node model. Somewhat surprisingly,
...
Now consider the code documentation of MATSim's \lstinline|queuesim.QueueNode.moveNode|
(as of December 2014):
\begin{quote}
