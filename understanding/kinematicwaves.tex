...
\ah{in \gls{jdeqsim} this can be configured by parameter \lstinline|gapTravelSpeed| (default: 15\,kilometers per hour ... seems to be taken in m/s in the code, I'll discuss with Rashid). Car size is configured with \gls{jdeqsim} parameter \lstinline|carSize| (default: 7.5\,meters).}
...
\ah{in \gls{jdeqsim} there is the \lstinline|minimumInFlowCapacity| parameter for ?? I do not get it. Discuss with Rashid.}
%
