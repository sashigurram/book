...
%
\kai{auch das jetzt folgende sollte schon woanders im Buch sein!} \ah{Chapter~\ref{ch:destinationchoice}. Vielleicht bin ich zu empfindlich, aber die Zitierweise in diesem Abschnitt finde ich verbesserungsbedürftig.}.
%
...
%
Such an approach can currently not be configured for \acrshort{matsim}; it needs to be programmed explicitly in Java. This has been performed for destination choice (see Chapter~\ref{ch:destinationchoice}) \ah{Ein typisches Beispiel für Genetic Drift. Frozen-Randomness und eine Methode das auch berechnabr zu machen wurde für Locationchoice nicht einfach bloss angewendet, sondern erfunden. }.
