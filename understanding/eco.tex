...
%
Not to be confused with the logit model scale parameter; we use $\mu$ here to be consistent with the time allocation literature. \kai{das steht weiter unten auch nochmal}
%
}
