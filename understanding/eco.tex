...
\ah{Relying on random seeds is for all but the simplest applications illusory. Literally, one additional draw heats up \ie destroys the the whole freeze. Removed this last sentences. ok?}
