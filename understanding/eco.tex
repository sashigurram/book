...
%
Such an approach can currently not be configured for \acrshort{matsim}; it needs to be programmed explicitly in Java. This has been performed for destination choice (see Chapter~\ref{ch:destinationchoice}) \ah{Ein typisches Beispiel für Genetic Drift. Frozen-Randomness wurde für Locationchoice nicht einfach bloss \textbf{angewendet, sondern \textbf{erfunden}. }.
