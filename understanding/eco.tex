...
\ah{M.E. ist an dieser Stelle $U$ nun hergeleitet ... anders als in Teil I und II.} \kai{Ist es dann $U$ oder $V$?  Also sind die epsilons schon drin (ah locachoice) oder nicht (bryan raney betaBrain)?  Würde m.E.\ dafür sprechen, hier lieber bei $S$ zu bleiben ...  Oder halt doch $U$, aber eine Fußnote dran.}
