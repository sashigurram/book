...
updating rule:
\gunnar{Make this consistent with the formulation in Agent-based DTA chapter.}
\begin{eqnarray}
...
(see Appendix~\ref{sec:derive-filtered-score}): \gunnar{Nummerierung seltsam.}
\begin{eqnarray}
...
% \appendix
\ah{Gunnar: Willst du hier einen Kapitel-Appendix oder einen Buch-Appendix? Hab es provisorisch in einen Buch-Appendix (appendix.tex) geworfen, damit das Dokument wieder vernünftig kompiliert.}
