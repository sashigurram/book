...
{}``mutation'', {}``selection'' and {}``execution'', borrowed from evolutionary computation \kai{ok?}, with a 
%mainstream
...
\end{itemize}
\end{enumerate}
This at first glance counter-intuitive behavior can be motivated as follows:\kai{previous sentence changed; pls check} Best response creates new plans that are by chance
