...
%
\benjamin{Insgesamt frage ich mich, ob dieser Ansatz nicht arg vom initialen choice set (aus dem zufällig ein Plan zum Entfernen ausgewählt wird) abhängt. Nehmen wir mal an, ein Agent hat am Anfang genau einen Plan, der ist extrem schlecht. Wie bekomme ich dann mit obigem Algo jemals bessere Pläne in das choice set? Die werden ja immer besser sein als dieser Plan, und somit nicht akzeptiert, oder?}
%
