...
To start out, it is assumed that these two values are the same (meaning,
clearly unrealistically, that scores do not change from one iteration to the
next.) The expected maximum utility of a plan $i$ could then be 
...
expression depends of course on the simulation's ability to create realistic
