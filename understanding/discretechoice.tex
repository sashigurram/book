...
\citet{Ben-AkivaBook} and \citet{Train2003discreteChoiceBook}. The theory is typically used 
...
(1) People chose randomly among their alternatives, rendering their behavior inherently unnpredictable.
...
of a scale parameter. Such behavior can be approximated in \acrshort{matsim} by
\begin{itemize}
\styleItemize
...
\section{\label{sec:stochasticity-and-repeated-choices}Stochasticity and Repeated Choices}
...
\end{enumerate}
%
These three issues might lead to biased behavior, and also have consequences for economic evaluation. 
A discussion of these aspects, as well as a presentation of possible solutions is given in Chapter
\note{REF to econ-eval}.
