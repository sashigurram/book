...
{Basic procedure of transport microsimulations \kai{network loadING simulation}}%
{\label{fig:maxUtf}}%
...
Natural conclusion here is, that back moving gaps are essential for generating a realistic MFD \kai{bis hier hin stimme ich zu}, in other words to realistically model to complete range of traffic conditions \kai{hier eigentlich nicht wirklich.}. Backward moving gaps are re-included in the default MATSim mobsim (qsim). 
