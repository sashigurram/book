...
\gunnar{(to self) Check if that discussion is still there.}
...
and the old plan, respectively. (Chapter~\note{REF Scoring}%\ref{sec:adjust-impr-funct}
...
provided in Sections~\note{REF Choice models in MATSim} and \note{REF CBA}.
...
choice theory; see Sections \note{REF choice models in matsim} and 
\ref{REF research avanues}.
...
with that option; see also Section~\note{REF Choice models in MATSim}.  
...
presumably realistic. Section~\note{REF discrete choice models}
relates this to random utility modeling; see also Section~\note{REF research avenues}.
...
of these problems. This is complemented by the subsequent Sections~\note{REF}, 
