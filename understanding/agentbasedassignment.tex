...
\gunnar{OK. Karmarkar scheint hier die Schl\"usselreferenz zu sein:}\citet{karmarkar1984}
...
``running MATSim as a standard DTA''? That would fit well in here, I think.} \kai{ok.  Not much of a tutorial, but at least an example plans file and some text with it.  Will do when I get around.}
