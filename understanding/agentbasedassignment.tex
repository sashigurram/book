...
The constant demand $q^{od}$ in \gls{od} relation $od$ splits up among a set of routes $K^{od}$. 
...
relates this to random utility modeling; see also Chapter~\ref{sec:choicesets}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Adjusting the \enquote{Improvement Function} from Shortest
