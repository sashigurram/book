...
The  first framework program of the European Union gave the chance to continue with the work in a larger context, but unfortunately this extended version of ORIENT/RV never went beyond the design stage \citep[][]{AxhausenGoodwin1991}. The EUROTOPP approach was later implemented in a changed from at the \gls{ifv} again by Zumkeller and his students, who had been one of the partners of the first framework project \citep[][]{SchnittgerZumkeller_ETC_2004}.

Moving to Oxford, London and then Innsbruck in relatively short order kept him from initiating serious work on a \gls{largescale} simulation system. 
...
\kwaah{While this \ah{replace} was low key at the beginning, the move of Balmer and Charypar to his group after Nagel's departure to TU Berlin jumped started the further work, which is now documented in the rest of this book.}
