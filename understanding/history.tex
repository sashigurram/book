...
At the end of the 1990’s \gls{matsim} merged these strands into a computationally efficient, open-source tool, that is increasingly used all over the world.
