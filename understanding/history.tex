...
%
We abstract"\karen{what do you mean here with 'abstract away?}" away from the notion that \gls{java} ``passes object references by value'' %\citep{...}.\ah{m.E. nicht nötig.}
%
