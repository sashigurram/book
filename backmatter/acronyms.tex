...
\newacronym{fit}{FIT}{feed-in tarif}
...
\newacronym[description={Mobility simulation. Also, depending on the context and the specific capabilities of the mobility simulation, called network loading, traffic flow simulation or synthetic reality}]{mobsim}{mobsim}{mobility simulation}
