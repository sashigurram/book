...
\newacronym[description={Quantum GIS see \url{http://docs.qgis.org/testing/en/docs/pyqgis_developer_cookbook/}}]{qgis}{QGIS}{Quantum GIS}
...
\newacronym[description={Verkehr In St\"adten \textendash\ UMlegung, see \url{www.ptv.de} and \citet{VISUM_manualNewFeatures_2011}}]{visum}{VISUM}{Verkehr In St\"adten \textendash\ UMlegung}
