...
\newglossaryentry{navteq}{
    name=NAVTEQ,
    description={Geographical information system data provider, in particular navigation maps},
		text={NAVTEQ}	
}

\newglossaryentry{node}{
    name=Node,
    description={A node is part of a MATSim network representing intersections. Note that intersections are not modeled explicitly in MATSim, \ie cars do not interact at intersections},
		text={node},
		plural={nodes},
}
...
\newglossaryentry{omnitrans}{
    name=OmniTRANS,
    description={Transport Modeling Software Platform},
		text={OmniTRANS}
}
...
\newglossaryentry{qsim}{
    name=QSim,
    description={The standard MATSim mobsim},
		text={QSim}	
}
...
\newglossaryentry{via}{
    name=Via,
    description={Via is the \gls{senozon} visualizer},
		text={Via}
}
