...
\newglossaryentry{cpp}{
    name=C++,
    description={C++ is an object-oriented programming language with full control of memory management},
		text={C++}
}

\newglossaryentry{eclipse}{
    name=Eclipse,
    description={The standard integated development environment (IDE) used by the MATSim developers},
		text={Eclipse}
}
