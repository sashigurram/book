...
\newglossaryentry{framework}{
    name=Framework,
    description={A software concept, providing generic functionality and application specific software. It is selectively changed by user code. MATSim is currently a framework, but develops towards also being useful as a library/toolbox.},
		text={framework},
		plural={framework},
}
...
\newglossaryentry{library}{
    name=Library,
    description={A set of routines providing services to independent programs. Usually it is not executable by itself},
		text={library},
		plural={libraries},
}
...
\newglossaryentry{matsimrun}{
    name=MATSim run,
    description={A set of a configurable number of \glspl{iteration}, typically ending with an equilibrium solution of transport supply and demand},
		text={MATSim run}	
}
...
\newglossaryentry{windows}{
		name=Windows,
    description={An operating system developed by Microsoft and first released in 1985},
