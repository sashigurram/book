...
\newglossaryentry{activitybased}{
    name=Activity-based,
    description={Modern transport planning assumes that ``\emph{travel demand is derived from activity demand}'' \citep[][]{Jones_HensherStopher_1979, Bowman_TEC_2009_1, Bowman_TEC_2009_2, BhatKoppelman_HallRW_2003, EttemaTimmermans_1997, BowmanBenAkiva_ABTFCEngelke_1996, BowmanBenAkiva_TransResA_2001}. People travel because they want to perform a certain activity, which is best captured by activity-based models with activities the central element of modeling},
		text={activity-based}
}

\newglossaryentry{activitylocation}{
    name=Activity location,
    description={People perform activities at activity locations, which can be as small as one single building or large zones. In MATSim, activity locations are often further specified by using the \gls{facility} object, which (in addition to others) define open times},
...
\newglossaryentry{agent}{
    name=Agent,
    description={According to \citet[][p.21]{Wooldridge_2009} an agent is ``\emph{is a computer system situated in an environment, capable of autonomous action in this environment  to meet its delegated objectives.}''},
		text={agent},
		plural={agents},
}
...
\newglossaryentry{contribution}{
    name=Contribution,
    description={An \gls{extension} contributed by \gls{matsim} community and hosted in the \gls{matsim} repository.  See  \url{http://matsim.org/extensions}. 
%%It residues in the \lstinline|org.matsim.contrib|
% nope, sorry.  kai, sep'15
},
		text={contribution},
...
\newglossaryentry{config}{
    ...
    description={The object in the \gls{matsim} code containing configuration options.  It can be modified by the \gls{configfile}, but also by other mains, in particular by scripts-in-\gls{java}},
    text={config},
    plural={configs},
}
...
\newglossaryentry{event}{
    name=Event,
    description={Small pieces of information reported by the mobsim, describing a simulation object action at a specific time},
		text={event},
		plural={events},
}
...
\newglossaryentry{extension}{
    name=Extension,
    description={Core MATSim uses only a \gls{configfile}, population file and network file, corresponding to the book's part~I MATSim. An extension is any code that extends this core MATSim, corresponding to this book's part~II. They hook to MATSim via the extension points described in Chapter~\ref{ch:extensionpoints}},
		text={extension},
		plural={extensions},
}
...
\newglossaryentry{framework}{
    name=Framework,
    description={A software concept, providing generic functionality and application-specific software. It is selectively changed by user code. MATSim is currently a framework, but is developing towards also being useful as a library/toolbox.},
		text={framework},
		plural={framework},
}
...
\newglossaryentry{javadoc}{
    name=Javadoc,
    description={Source code documentation compiled from javadoc annotations in the source files},
		text={javadoc}
}
...
\newglossaryentry{leg}{
    name=Leg,
    description={A plan element,part of a \gls{trip} performed with a specific mode. In transport planning, this is often called a \gls{stage}},
		text={leg},
		plural={legs},
}
...
\newglossaryentry{library}{
    name=Library,
    description={A set of routines providing services to independent programs. Usually not executable on its own},
		text={library},
		plural={libraries},
}
...
\newglossaryentry{link}{
    name=Link,
    description={A network component representing streets},
		text={link},
		plural={links},
}
...
\newglossaryentry{linux}{
    name=Linux,
    description={A unix-like operating system released by Linus Torvalds at the end of 1991},
		text={Linux},
}
...
\newglossaryentry{matsimrun}{
    name=MATSim run,
    description={A configurable number set of \glspl{iteration}, typically ending with an equilibrium solution of transport supply and demand},
		text={MATSim run}	
}
...
%%}
%
%%Habe ich rausgestrichen: Ein microcensus ist m.E. ein ganz typisches
%%statistisches Werkzeug und existiert auch außerhalb CH.  DAS könnte
%%ich nun selbst reparieren ... aber die meisten microcensus Erhebungen
%%enthalten m.E. keinen travel survey; wenigstens in D ist das separat
%%(MiD, SrV), und auch in in US m.E. (PUMS = public use microsample data
%%vs NHTS = national household travel survey).
% 
%Obwohl (Swiss) microcensus im Text oft vorkommt, wurde \gls{microcensus} ohnehin nur selten verwendet.
%
% kai, sep'15
%
...
\newglossaryentry{module}{
    name=Module,
    description={According to Merriam-Webster (\url{http://www.merriam-webster.com}), a module is ``one of a set of parts that can be connected or combined to build or complete something'' or more specifically ``a part of a computer or computer program that does a particular job''. That is, ``module'' is not a very specific term, and, in consequence, modules exist in MATSim at many levels},
		text={module},
		plural={modules},
}
...
\newglossaryentry{navteq}{
    name=NAVTEQ,
    description={A geographical information system data provider, particularly for navigation maps},
		text={NAVTEQ}	
}
...
\newglossaryentry{objectivefunction}{
    ...
    description={A central element in optimization problems, among others. An objective function, sometimes also called loss or cost function, is mapping of candidate solutions onto a real number},
...
%    %name=Parameter,
%    %description={Program parameter vs. statistical parameters ... \todoah{\kai{Andreas, fehlt hier etwas?  Ich haette auch nichts dagegen, das ganz rauszustreichen, scheint mir nicht so zentral.}}},
%		%text={parameter},
%		%plural={parameters},
%}
...
\newglossaryentry{study}{
    name=Study,
    description={The basic organizational unit of research in empirical science. Comparable to the experiment in natural sciences},
		text={study}
}
...
\newglossaryentry{teleport}{
    name=Teleport,
    description={Moving vehicles from origin to destination, at a predefined speed, without considering interactions in the network},
		text={teleport}
}
...
\newglossaryentry{trafficassignment}{
    ...
    description={Traditionally, this is the last step of the four-step model, calculating trip distribution over the different routes between \glspl{od}-pairs. Dynamic traffic assignment additionally considers respective departure time choices},
...
\newglossaryentry{transit}{
    name=Transit,
    description={Public transport. In German-speaking countries (``Transit Verkehr''): ambiguously used for traffic going through cities or countries with neither origin nor destination there},
		text={transit}
}
...
\newglossaryentry{unix}{
		name=Unix,
    description={An operating system developed during the 1970s at the Bell Labs Research Center},
		text={unix}
}

\newglossaryentry{utility}{
    name=Utility,
    description={A central economic concept representing satisfaction through goods consumption. The MATSim score can be interpreted in utility units},
		text={utility}
}
...
\newglossaryentry{windows}{
		name=Windows,
    description={An operating system developed by Microsoft, first released in 1985},
