...
\newglossaryentry{arcgis}{
    name=ArcGIS,
    description={is ESRI's geographic information system},
		text={ArchGIS},
}

\newglossaryentry{contribution}{
    name=Contribution,
    description={A MATSim contribution (short ``contrib'') is an \gls{extension} that made it into an official MATSim release. It residues in the \lstinline|org.matsim.contrib| and can be downloaded from \url{http://www.matsim.org/docs/extensions}},
		text={contribution},
...
\newglossaryentry{core}{
    name=Core,
    description={MATSim core ...},
		text={core}
}

\newglossaryentry{cpp}{
    name=C++,
    description={is an object-oriented programming language with full control of memory management},
		text={C++}
}
...
\newglossaryentry{eclipse}{
    name=Eclipse,
    description={is the standard integrated development environment (IDE) used by the MATSim developers},
		text={Eclipse}
}
...
\newglossaryentry{extension}{
    name=Extension,
    description={MATSim extensions are written by \gls{api} users. An extension is code extending MATSim base functionality and hooking to MATSim via the extension points provided in the \gls{api}. If extensions are included in a MATSim release in \lstinline|org.matsim.contrib| then they are called MATSim contributions},
		text={extension},
		plural={extensions},
}
...
\newglossaryentry{facility}{
    name=Facility,
    description={is an optional element in MATSim to further specify an \gls{activitylocation}},
		text={facility},
		plural={facilities},
}
...
\newglossaryentry{framework}{
    name=Framework,
    description={provides generic functionality and application specific software. It is selectively changed by user code. MATSim is currently a framework},
		text={framework},
		plural={framework},
}
...
\newglossaryentry{java}{
    name=Java,
    description={is a modern object-oriented programming language and is cross-platform capable due to its bytecode run in any Java virtual machine},
...
\newglossaryentry{javadoc}{
    name=Javadoc,
    description={is source code documentation that is compiled from javadoc annotations in the dource files},
		text={javadoc}
}

\newglossaryentry{jenkins}{
    name=Jenkins,
    description={is a software tool for continous integartion},
		text={Jenkins}
}
...
\newglossaryentry{leg}{
    name=Leg,
    description={is part of a \gls{trip} performed with a specific mode. In transport planning this is often called a \gls{stage}},
		text={leg},
		plural={legs},
}
...
\newglossaryentry{library}{
    name=Library,
    description={is a set of routines providing services to independent programs. Usually it is not executable},
		text={library},
		plural={libraries},
}
...
\newglossaryentry{link}{
    name=Link,
    description={is part of a MATSim network representing the streets},
		text={link},
		plural={links},
}
...
\newglossaryentry{matsimrun}{
    name=MATSim run,
    description={is composed of a configurable number of \glspl{iteration} and ends with an equilibrium solution of transport supply and demand},
		text={MATSim run}	
}

\newglossaryentry{maven}{
    name=Maven,
    description={is a build automation tool tailored to \gls{java}},
		text={Apache Maven}
}
...
\newglossaryentry{model}{
    name=Model,
    description={reduces a \gls{system} to the aspects relevant for understanding or solving a specific problem},
		text={model}	
}
...
\newglossaryentry{navteq}{
    name=NAVTEQ,
    description={is a geographical information system data provider, in particular for navigation maps},
		text={NAVTEQ}	
}

\newglossaryentry{node}{
    name=Node,
    description={is part of a MATSim network representing intersections. Note that intersections are not modeled explicitly in MATSim, \ie cars do not interact at intersections},
		text={node},
		plural={nodes},
}
...
\newglossaryentry{omnitrans}{
    name=OmniTRANS,
    description={is a transport Modeling Software Platform},
		text={OmniTRANS}
}
...
\newglossaryentry{plan}{
    name=Plan,
    description={contains the agent's day schedule and after run completion an associated \gls{score}},
		text={plan},
		plural={plans},
}
...
\newglossaryentry{qsim}{
    name=QSim,
    description={is the standard MATSim mobsim},
		text={QSim}	
}

\newglossaryentry{replanning}{
    name=Replanning,
    description={denotes the stage where agents (randomly) modify their plans},
		text={replanning}	
}
...
\newglossaryentry{senozon}{
    name=Senozon AG,
    description={is a spin-off company founded by two core programers of MATSim},
		text={Senozon AG}
}
...
\newglossaryentry{sustaincity}{
    name=SustainCity,
    description={is a project addressing the modeling and computational issues of integrating modern mobility simulations with the latest \gls{microsimulation} land use models, see \url{http:\\www.sustaincity.org}},
		text={SustainCity}
}
...
\newglossaryentry{toolkit}{
    name=Toolkit,
    description={is a collection of tools},
		text={toolkit}
}
...
\newglossaryentry{trip}{
    name=Trip,
    description={connects two \glspl{activity} and is composed of multiple \glspl{leg}},
		text={trip},
		plural={trips},
}
...
\newglossaryentry{via}{
    name=Via,
    description={is the \gls{senozon} visualizer},
		text={Via}
}
