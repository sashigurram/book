...
\newglossaryentry{java}{
    name=Java,
    description={A modern object-oriented programming language and is cross-platform capable due to its bytecode run in any Java virtual machine},
...
\newglossaryentry{model}{
    name=Model,
    description={A universal concept reducing a real \gls{system} to the aspects relevant for understanding or solving a specific problem},
		text={model}	
}
